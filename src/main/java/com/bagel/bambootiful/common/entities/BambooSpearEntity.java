package com.bagel.bambootiful.common.entities;

import javax.annotation.Nullable;

import com.bagel.bambootiful.core.registry.BambooEntities;
...
public class BambooSpearEntity extends AbstractArrowEntity {
   ...
   private ItemStack thrownStack = new ItemStack(BambooItems.DRIED_BAMBOO.get());
   private boolean dealtDamage;
   public int returningTicks;

   public BambooSpearEntity(EntityType<? extends BambooSpearEntity> p_i50148_1_, World p_i50148_2_) {
      super(p_i50148_1_, p_i50148_2_);
   }

   public BambooSpearEntity(World p_i48790_1_, LivingEntity p_i48790_2_, ItemStack p_i48790_3_) {
      super(BambooEntities.BAMBOO_SPEAR, p_i48790_2_, p_i48790_1_);
   ...
   @OnlyIn(Dist.CLIENT)
   public BambooSpearEntity(World p_i48791_1_, double p_i48791_2_, double p_i48791_4_, double p_i48791_6_) {
      super(BambooEntities.BAMBOO_SPEAR, p_i48791_2_, p_i48791_4_, p_i48791_6_, p_i48791_1_);
   }
