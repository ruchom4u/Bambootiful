package com.bagel.bambootiful.common.items;
...
public class BlowpipeItem extends ShootableItem {
   private boolean field_220034_c = false;
   private boolean field_220035_d = false;

   public BlowpipeItem(Item.Properties p_i50052_1_) {
      super(p_i50052_1_);
   ...
   private static float func_220013_l(ItemStack p_220013_0_) {
      return p_220013_0_.getItem() == BambooItems.DRIED_BAMBOO.get() && hasChargedProjectile(p_220013_0_, Items.FIREWORK_ROCKET) ? 1.6F : 3.15F;
   }
}