package com.bagel.bambootiful.client.renderer;

import com.bagel.bambootiful.client.model.BambooSpearModel;
import com.bagel.bambootiful.common.entities.BambooSpearEntity;
...
public class BambooSpearRenderer extends EntityRenderer<BambooSpearEntity> {
   public static final ResourceLocation field_203087_a = new ResourceLocation("bambootiful:textures/entity/bamboo_spear.png");
   private final BambooSpearModel field_203088_f = new BambooSpearModel();

   public BambooSpearRenderer(EntityRendererManager p_i48828_1_) {
      super(p_i48828_1_);
   }

   public void doRender(BambooSpearEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
   ...
   protected ResourceLocation getEntityTexture(BambooSpearEntity entity) {
      return field_203087_a;
   }

   @SuppressWarnings("unused")
protected void func_203085_b(BambooSpearEntity p_203085_1_, double p_203085_2_, double p_203085_4_, double p_203085_6_, float p_203085_8_, float p_203085_9_) {
