...
public class BambooSpearEntityRenderer extends EntityRenderer<BambooSpearEntity> {
   ...
   public BambooSpearEntityRenderer(EntityRendererManager p_i48828_1_) {
      super(p_i48828_1_);
   }

   public void func_225623_a_(BambooSpearEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
