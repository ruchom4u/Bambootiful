...
public class BambooBlocks
{
    ...
    public static RegistryObject<Block> BAMBOO_TRAPDOOR 		= RegistryUtils.createBlock("bamboo_trapdoor", () -> new TrapDoorBlock(Block.Properties.from(BAMBOO_PLANKS.get())), ItemGroup.REDSTONE);
    ...
    public static RegistryObject<Block> BAMBOO_DOOR 			= RegistryUtils.createBlock("bamboo_door", () -> new DoorBlock(Block.Properties.from(BAMBOO_PLANKS.get())), ItemGroup.REDSTONE);
    ...
    public static RegistryObject<Block> BAMBOO_LADDER		 	= RegistryUtils.createBlockCompat("quark", "bamboo_ladder", () -> new LadderBlock(Block.Properties.from(Blocks.LADDER)), ItemGroup.DECORATIONS); 
    ...
    public static RegistryObject<Block> DRIED_BAMBOO_TRAPDOOR 			= RegistryUtils.createBlock("dried_bamboo_trapdoor", () -> new TrapDoorBlock(Block.Properties.from(DRIED_BAMBOO_PLANKS.get())), ItemGroup.REDSTONE);
    ...
    public static RegistryObject<Block> DRIED_BAMBOO_DOOR 				= RegistryUtils.createBlock("dried_bamboo_door", () -> new DoorBlock(Block.Properties.from(BAMBOO_PLANKS.get())), ItemGroup.REDSTONE);
    ...
    public static RegistryObject<Block> DRIED_BAMBOO_LADDER		 		= RegistryUtils.createBlockCompat("quark", "dried_bamboo_ladder", () -> new LadderBlock(Block.Properties.from(Blocks.LADDER)), ItemGroup.DECORATIONS); 
